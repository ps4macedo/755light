...
function setupRW() {
	...
	debug_log("");
	debug_log("");
	debug_log("A G U A R D E ! ! ! UNS 16 SEGUNDOS PARA EXECUÇÃO DO JAILBREAL DO SLEIRSGOEVY VERSÃO DE 27/05/2021 E ATIVAÇÃO DO GOLDHEN V1.1 (SiSTRO).");
	debug_log("");
	debug_log("");
	debug_log("");
	debug_log("P S 4 M A C E D O 7 5 5");
	debug_log("");
	debug_log("");
	debug_log("");
	debug_log("BOA DIVERSÃO ! ! !");
...
function leakJSC() {
	...
	if (g_relative_read === null)
		die("Cache offline carregada!!! Saia e entre novamente no navegador.");
